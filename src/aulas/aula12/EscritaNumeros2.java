...
public class EscritaNumeros2 {
	...
	public static void main(String[] args) {
		...
		try {
			...
			PrintWriter fluxoArquivo = new PrintWriter("src/aulas/aula12/arquivos/exemplo03.txt");
			...
			do {
				...
				if (n != 0)						// se número fornecido por diferente de 0 (zero)...
					fluxoArquivo.println(n);		// gravação de número em arquivo
			} while (n != 0);
